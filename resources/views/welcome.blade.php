...
<body>
    ...
    <div class="container text-center py-5">
        <h2 class="font-weight-bold">Ready to get started?</h2>
        <p class="mb-4">Explore our affordable plans or try our free tier.</p>
        <a href="#" class="btn btn-lg btn-success">View Pricing & Signup</a>
    </div>
